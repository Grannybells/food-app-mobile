...
import { StyleSheet, View, Text, StatusBar, TouchableOpacity, ScrollView, Image, TextInput } from "react-native"; // Import components from React Native
...
const styles = StyleSheet.create({
    ...
    header: {
        paddingTop: 10, // Use absolute units for padding
        paddingHorizontal: 10, // Use absolute units for padding
        height: '20%',
        gap: 10, // Use absolute units for gap
    },

    body: {
        padding: 10, // Use absolute units for padding
    },
    ...
    sectionText: {
        fontSize: 20, // Use absolute units for font size
        fontWeight: 'bold',
    },
    ...
    subText: {
        fontSize: 16, // Use absolute units for font size
    },
